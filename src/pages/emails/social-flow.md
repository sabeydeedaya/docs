...
This guide will walk you through how to setup your email campaigns with **[Social Flow](https://socialflow.com){:target="\_blank"}** using Branch Universal Email to automatically convert your email links into **multi-platform deep links**
...
![image](/img/pages/email/social-flow/setup-config.png)
