...
![MessageGears](/img/pages/email/messagegears/messagegears.png)

This guide will walk you through how to setup your email campaings with **[MessageGears](https://messagegears.com/){:target="\_blank"}** using Branch Universal Email to automatically convert your email links into **multi-platform deep links**
...
Navigate to the [Deep Linked Email](https://dashboard.branch.io/email){:target="\_blank"} section of the Branch dashboard. Select **MessageGears** and click **Enable**.
...
![image](/img/pages/email/messagegears/setup-config.png)
