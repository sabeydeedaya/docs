...
This guide will walk you through how to setup your email campaigns with **[Vibes](https://vibes.com){:target="\_blank"}** using Branch Universal Email to automatically convert your email links into **multi-platform deep links**
...
Navigate to the [Universal Email](https://dashboard.branch.io/email){:target="\_blank"} section of the Branch dashboard. Select **Vibes** and click **Enable**.
...
![image](/img/pages/email/vibes/setup-config.png)
